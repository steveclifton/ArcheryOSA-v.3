  ...
  <div class="row">
        <div class="col-sm-12">
            <div class="page-title-box">
                <h4 class="page-title"><a href="/admin/divisionages">Division Ages</a> > <a href="javascript:;">Update</a></h4>
            </div>
        </div>
    </div>
    <!-- end col -->
    ...
    <div class="col-md-8 offset-md-2">
        <div class="card-box">
            ...
            <form class="form-horizontal myForms" method="POST" action="/admin/divisionages/update/{{$division->divisionagesid}}" role="form">
                @csrf
