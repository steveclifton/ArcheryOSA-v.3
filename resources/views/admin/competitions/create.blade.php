...
<div class="row">
    ...
    <div class="col-md-8 offset-md-2">
        <div class="card-box">
            <h4 class="m-t-0 m-b-30 text-center addFormHeader header-title">Archery NZ</h4>

            <form class="form-horizontal myForms" role="form">
            	 <div class="form-group row">
                    <label for="inputOrgName3" class="col-sm-12 col-md-3 col-form-label">Organisation Name*</label>
                    <div class="col-md-9">
