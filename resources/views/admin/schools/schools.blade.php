    ...
    <div class="col-sm-12">
        ...
        <div class="container" style="margin-left: 0; padding-left: 0;">
            <div class="row">
                ...
                <div class="col-xs-6">
                    <a role="button" href="/admin/schools/create" class="btn btn-inverse waves-effect waves-light ">
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            @foreach($schools as $school)
                                <tr>
                                    <th scope="row">
                                        <a href="/admin/schools/update/{{$school->schoolid}}">{{ucwords($school->label)}}</a>
                                    </th>
                                    <th>{{$school->email}}</th>
                                    <td>
                                        @if($school->visible)
