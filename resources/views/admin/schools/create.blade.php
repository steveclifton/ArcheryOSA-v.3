...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-title-box">
                <h4 class="page-title"><a href="/admin/schools">Schools</a> > <a href="javascript:;">Create</a></h4>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-8 offset-md-2">
        <div class="card-box">
            <h4 class="m-t-0 m-b-30 text-center addFormHeader header-title">Create New School</h4>

            <form class="form-horizontal myForms" action="/admin/schools/create" method="POST" role="form">
                @csrf
