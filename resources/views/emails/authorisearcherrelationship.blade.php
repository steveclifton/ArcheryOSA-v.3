                                        ...
                                        <table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;">
                                            <tr>
                                                <td style="padding-right: 10px; padding-left: 10px; padding-top:0px; padding-bottom:30px;" align="center">
                                                    <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="www.archeryosa.com/profile" style="height:50px; v-text-anchor:middle; width:124px;" arcsize="6%" strokecolor="#2a2e2e" fillcolor="#2a2e2e">
                                                        <w:anchorlock/>
                                                        <center style="color:#ffffff; font-family:'Lato', Tahoma, Verdana, Segoe, sans-serif; font-size:18px;">
                                        <![endif]-->
                                        <a href="{{$url}}/{{$hash}}" target="_blank" style="display: block;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #ffffff; background-color: #2a2e2e; border-radius: 3px; -webkit-border-radius: 3px; -moz-border-radius: 3px; max-width: 124px; width: 84px;width: auto; border-top: 0px solid transparent; border-right: 0px solid transparent; border-bottom: 4px solid #59B7E0; border-left: 0px solid transparent; padding-top: 5px; padding-right: 20px; padding-bottom: 5px; padding-left: 20px; font-family: 'Lato', Tahoma, Verdana, Segoe, sans-serif;mso-border-alt: none">
