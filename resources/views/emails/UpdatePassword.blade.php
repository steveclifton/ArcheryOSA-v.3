                            ...
                            <div style="background-color: transparent; width: 100% !important;">
                                <!--[if (!mso)]><!--><!--[if (!IE)]><!--><div style="border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent; padding-top:5px; padding-bottom:15px; padding-right: 0px; padding-left: 0px;"><!--<![endif]--><!--<![endif]-->
                                    ...
                                    <div style="padding-right: 10px; padding-left: 10px; padding-top: 15px; padding-bottom: 20px;">
                                        ...
                                        <div align="center"><div style="border-top: 10px solid #222a2a; width:15%; line-height:10px; height:10px; font-size:10px;">&#160;</div></div>
                                        <!--[if (mso)]></td></tr></table></td></tr></table><![endif]-->
                                    </div>
                                        ...
                                        <div style="font-size:12px;line-height:22px;color:#555555;font-family:'Lato', Tahoma, Verdana, Segoe, sans-serif;text-align:left;">
                                            <p style="margin: 0;font-size: 14px;line-height: 25px;text-align: center">
                                                <span style="font-size: 16px; line-height: 28px;">
                                                    <span style="line-height: 28px; font-size: 16px;">Just a heads up, your password has been updated and you are ready to continue using ArcheryOSA!</span>
                                                </span>
                                            </p>
                                        </div>
                                    </div>
